...
Recently, the Enigma has moved up the pop-culture food chain - after being featured prominently in the Alan Turing biopic, the Imitation Game. And while Turing made fantastic contributions, no one country or team broke the Enigma, rather, it was the concerted efforts of many individuals. 

Rarely featured are the efforts of [Marian Rejewski](https://en.wikipedia.org/wiki/Cryptanalysis_of_the_Enigma#Polish_breakthrough) and his team of Polish mathematicians who made the first great breakthrough that allowed for later progress. The British Bombe, developed by Turing for the British Government to decrypt Enigma ciphers, was based on the Poles’ own machine, the _bomba kryptologiczna_ (“cryptologic bomb”) in both name and basic functionality. Without the Polish Team's breakthroughs, Turing would never have been able to construct his own Bombe in Bletchley.

So, while it's wonderful that different unique stories from the history of cryptology are being told, there's still a myriad of perspectives and roles left to portray - beyond the contributions of just one nation or one team.

If you have any burgeoning interest in the history of the Enigma - and you are magically transported to / conveniently in the D.C. area - I highly recommend visiting the National Cryptologic Musuem to see not only the Enigma Machine - but also the larger history of cryptology.
